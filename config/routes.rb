Rails.application.routes.draw do
  ...
  get '/agendar/reserva/:booking_token', to: 'public/calendar_booking_manage#show'
  get '/agendar/reserva/:booking_token/calendario', to: 'public/calendar_booking_manage#ics'
  get '/agendar/reserva/:booking_token/disponibilidade', to: 'public/calendar_booking_manage#availability'
  post '/agendar/reserva/:booking_token/vaga', to: 'public/calendar_booking_manage#hold'
  post '/agendar/reserva/:booking_token/remarcar', to: 'public/calendar_booking_manage#reschedule'
  post '/agendar/reserva/:booking_token/cancelar', to: 'public/calendar_booking_manage#cancel'
  ...
  post '/agendar/convite/:private_token/:procedure_slug/vaga', to: 'public/calendar_bookings#private_hold'
  post '/agendar/convite/:private_token/:procedure_slug/vaga/:hold_token/confirmar', to: 'public/calendar_bookings#private_confirm'
  ...
  post '/agendar/:public_token/:procedure_slug/vaga', to: 'public/calendar_bookings#hold'
  post '/agendar/:public_token/:procedure_slug/vaga/:hold_token/confirmar', to: 'public/calendar_bookings#confirm'
