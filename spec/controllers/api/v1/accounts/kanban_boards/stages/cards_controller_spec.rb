...
RSpec.describe 'Kanban stage cards API', type: :request do
  ...
  def compact_card_keys
    %w[
      id kanban_stage_id position origin subject active lock_version due_at starts_at stage_entered_at contact inbox conversation_id priority
      ...
      closed_by_id closed_by amount_cents amount_currency expected_close_date custom_field_values compact_custom_fields stale_in_stage reply_state
