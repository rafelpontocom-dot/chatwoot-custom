<!--
  Raevo · Sereno — cópia de ContactsIndex.vue com a lista trocada pela tabela
  do Raevo. Diferença em relação ao original: UMA linha de import.

  Esta tela é NOSSA por decisão de 29/08/2026: melhorias do Chatwoot em
  ContactsIndex.vue não chegam aqui. Para reincorporar mudanças do upstream,
  copie o arquivo original de novo e reaplique a troca do import.

  Ver docs/raevo-design-system.md e AGENTS.md.
-->
<script setup>
...
import ContactsList from 'dashboard/components-next/raevo/RaevoContactsList.vue';
