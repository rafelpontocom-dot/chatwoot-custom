...
<template>
  ...
  >
    ...
    <div class="min-h-0 flex-1 overflow-y-auto px-2 py-2">
      ...
      >
        <summary
          class="flex h-7 cursor-pointer list-none items-center gap-2 px-1.5 text-2xs font-semibold uppercase tracking-wide text-n-slate-10 marker:content-none hover:text-n-slate-12"
        >
          <i
