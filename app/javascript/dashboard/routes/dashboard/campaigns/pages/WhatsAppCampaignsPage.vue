...
// Raevo · Sereno — tabela do Raevo no lugar dos cartões do Chatwoot.
// Ver RaevoCampaignList.vue e docs/raevo-design-system.md.
import CampaignList from 'dashboard/components-next/raevo/RaevoCampaignList.vue';
