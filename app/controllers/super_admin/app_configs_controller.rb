class SuperAdmin::AppConfigsController < SuperAdmin::ApplicationController
  CONFIG_GROUPS = {
    ...
    'google' => %w[GOOGLE_OAUTH_CLIENT_ID GOOGLE_OAUTH_CLIENT_SECRET GOOGLE_OAUTH_REDIRECT_URI ENABLE_GOOGLE_OAUTH_LOGIN
                   GOOGLE_CALENDAR_OAUTH_CLIENT_ID GOOGLE_CALENDAR_OAUTH_CLIENT_SECRET GOOGLE_CALENDAR_OAUTH_CALLBACK_URL],
    'captain' => %w[CAPTAIN_OPEN_AI_API_KEY CAPTAIN_OPEN_AI_MODEL CAPTAIN_OPEN_AI_ENDPOINT],
    # App Meta proprio do Lead Ads: o do Messenger nao serve, porque um app da
    # Meta so aceita um callback por tipo de objeto.
